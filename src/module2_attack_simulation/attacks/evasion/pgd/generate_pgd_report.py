...
def generate_pgd_report(json_file, md_file):
    with open(json_file, "r") as f:
        data = json.load(f)

    lines = []
    lines.append("# Evasion Attack Report — PGD\n")
    lines.append("## Overview\n")
    lines.append(f"- **Attack Type:** {data['attack_type']}")
    lines.append(f"- **Epsilon:** {data['epsilon']}")
    lines.append(f"- **Alpha (step size):** {data['alpha']}")
    lines.append(f"- **Number of Iterations:** {data['num_iter']}")
    lines.append(f"- **Random Start:** {data['random_start']}\n")
    ...
    lines.append(
        "The following examples illustrate adversarial inputs generated by the PGD attack. "
    ...
    print(f"[✔] PGD report generated at: {md_file}")
