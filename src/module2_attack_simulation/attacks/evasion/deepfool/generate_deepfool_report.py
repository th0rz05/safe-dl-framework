...
def generate_deepfool_report(json_file, md_file):
    with open(json_file, "r") as f:
        data = json.load(f)

    lines = []
    lines.append("# Evasion Attack Report — DeepFool\n")
    lines.append("## Overview\n")
    lines.append(f"- **Attack Type:** {data['attack_type']}")
    lines.append(f"- **Maximum Iterations:** {data['max_iter']}")
    lines.append(f"- **Overshoot Parameter:** {data['overshoot']}\n")
    ...
    lines.append(
        "The following examples illustrate adversarial inputs generated by the DeepFool attack. "
    ...
    print(f"[✔] DeepFool report generated at: {md_file}")
